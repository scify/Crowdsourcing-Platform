...
- [Run Tests](#run-tests)
  ...
  - [PHPUnit with the `php artisan test` command](#phpunit-with-the-php-artisan-test-command)
  - [Run the tests with the `run-tests.sh` script](#run-the-tests-with-the-run-testssh-script)
