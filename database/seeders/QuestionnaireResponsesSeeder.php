...
class QuestionnaireResponsesSeeder extends Seeder {
    ...
    public function run() {
        $questionnaireResponses = [
            ...
            ['id' => 1, 'questionnaire_id' => 2, 'project_id' => 2, 'user_id' => 1, 'language_id' => 6, 'response_json' => '{ "question2": "item1", "question3": "Lorem ipsum" }', 'response_json_translated' => '{ "question2": "item1", "question3": "Lorem ipsum" }'],
        ];
