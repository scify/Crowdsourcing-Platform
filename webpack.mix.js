...
mix.js('resources/assets/js/common.js', 'public/dist/js/')
    ...
    .js('resources/assets/js/pages/questionnaire/questionnaire-report.js', 'public/dist/js')
    ...
    .extract([
        'jquery','jquery-slimscroll', 'fastclick', 'admin-lte', 'bootstrap-sweetalert', 'select2', 'bootstrap', 'jquery-toast-plugin'
    ])
    .sourceMaps()
    .webpackConfig({
        devtool: 'source-map'
...
mix.sass('resources/assets/sass/common.scss', 'public/dist/css')
    ...
    .sass('resources/assets/sass/pages/crowdsourcing-project/reports.scss', 'public/dist/css')
