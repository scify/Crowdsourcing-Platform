...
function renderRowsFull(table, visualizer) {
	...
	answers.forEach(function (value) {
		...
		if (annotation) adminReviewStatusId = annotation.admin_review_status_id ? annotation.admin_review_status_id : 0;
...
/**
 * Renders the answers of a free-text ("text"/"comment") question as a sortable table
 * with vote and annotation controls (survey-analytics custom visualizer).
 */
export default class FreeTextQuestionStatisticsCustomVisualizer extends VisualizerBase {
	constructor(question, data, options) {
		super(question, data, options, "freeTextVisualizer");
	}
