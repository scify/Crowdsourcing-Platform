		...
		<div class="col-12 col-md-10 col-lg-11 col-xl-9">
			<div class="container-fluid p-0">
				...
				<ul class="row">
					...
					<li v-for="solution in solutions" :key="solution.id" class="col-12">
...
export default {
	...
	methods: {
		...
		getBtnTextColor() {
			return this.buttonTextColorTheme === "light" ? "#ffffff" : "#212529";
		},
...
.upvote-count {
	...
	padding: 0 0.5rem;
	border-radius: 2rem;
	background-color: v-bind(getBtnTextColor_80percent());
}
