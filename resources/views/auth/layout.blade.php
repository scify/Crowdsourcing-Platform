...
<body class="hold-transition background-page @yield('body_class')" style="background-image: url('{{ asset('images/projects/' . config('app.project_slug') . '/active_participation.png') }}');">
