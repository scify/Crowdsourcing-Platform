...
<div class="col-md-12 gamification-badge {{ $badge->level == 0 ? 'locked' : 'unlocked' }}"
    ...
    <div class="col-md-12 mt-2">
        ...
        @else
            <h6 class="badgeLevel" style="color: black; text-align: center; margin: 0.5rem 0; ">Level: <span class="points" style="font-weight: bold;">0</span></h6>
            <h5 class="badgeMessage" style="color: black; text-align: center; margin: 0.5rem 0;">You don't own this badge</h5>
        @endif
    </div>
</div>
