...
<!--FACEBOOK-->
<meta property="og:title" content="{{ __('common.home_motto') }} {{ __('common.home_sub_motto') }}" >
...
<meta property="twitter:title" content="{{ __('common.home_motto') }} {{ __('common.home_sub_motto') }}" >
