                    ...
                    <div class="features-wrapper">
                        <div class="features-list">
                            <div class="feature img-left">
                                <img loading="lazy" src="{{asset('images/landing-page/features/participate.webp')}}" alt="participate">
                            ...
                            <div class="feature img-right">
                                ...
                                <img loading="lazy" src="{{asset('images/landing-page/features/impact.webp')}}" alt="impact">
                                <p class="small-screens"><b>Check the impact</b> of your contribution, after the
                                    citizens opinions transform into a publicly available report.</p>
                            </div>
                            <div class="feature img-left">
                                <img loading="lazy" src="{{asset('images/landing-page/features/keep-track.webp')}}" alt="keep track">
                            ...
                            <div class="feature img-right">
                                <p class="large-screens"><b>Invite your friends</b> to contribute to projects that
                                    actually matter.</p>
                                <img loading="lazy" src="{{asset('images/landing-page/features/invite.webp')}}" alt="invite">
                                <p class="small-screens"><b>Invite your friends</b> to contribute to projects that
                                    actually matter.</p>
                            </div>
                            <div class="feature img-left">
                                <img loading="lazy" src="{{asset('images/landing-page/features/celebrating.webp')}}" alt="celebrating">
                ...
                <div role="tabpanel" class="tab-pane fade" id="managers">
                    <div class="features-wrapper">
                        <div class="features-list">
                            ...
                            <div class="feature img-left">
                                <img loading="lazy" src="{{asset('images/landing-page/features/integrate.webp')}}" alt="integrate">
