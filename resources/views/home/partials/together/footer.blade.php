            ...
            <div class="row pt-5">
                <div class="col-md-4 col-sm-12">
                    <div class="footer-grp">
                        <h3>"Together" Crowdsourcing Platform</h3>
                        <div class="mb-1">
                            <a href="https://scify.org/en" target="_blank">{{ __('common.about_us') }}</a>
                        </div>
                        <div class="mb-1">
                ...
                <div class="col-md-3 col-sm-12">
                    <div class="footer-grp">
                        ...
                        <div>
                            <b>{{ __('common.phone') }}:</b> +30 2114004192
                        </div>
                        <div>
                            <b>{{ __('common.email') }}:</b> info(at)scify.org
                        </div>
                        <div class="social-media">
                            ...
                            <a href="https://www.linkedin.com/company/scify-not-for-profit-company/" title="LinkedIn"
                               class="social-btn linkedin"
                               target="_blank"><i class="fab fa-linkedin-in"></i>
                            </a>
                            <a href="https://x.com/SciFY_org" title="Twitter" class="social-btn twitter"
                               target="_blank"><i class="fab fa-twitter"></i>
                            </a>
                            <a href="https://www.youtube.com/SciFYNPO" title="Youtube"
                               class="social-btn youtube" target="_blank"><i class="fab fa-youtube"></i>
                            </a>
                            <a href="https://www.instagram.com/scify_scienceforyou/" title="Instagram"
                        ...
                        <div class="row text-center">
                            <div class="col mx-auto">
                                <a href="https://ecas.org" target="_blank"><img loading="lazy" class="footer-logo"
                                                                                ...
                                                                                src="{{asset('images/scify_logo_108.png')}}"
                                                                                alt="SciFY logo"></a>
                            </div>
                        </div>
                        <div class="row">
