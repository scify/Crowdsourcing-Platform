                ...
                <div class="col mx-auto">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                <p>As a crowdsourcing platform we welcome everyone, and encourage a friendly and positive environment.
                                    This code of conduct outlines our expectations for participants for successful participation, as well as steps to reporting unacceptable behavior. We are committed to providing a welcoming and inspiring environment for all and expect our code of conduct to be honored. Anyone who violates this code of conduct may be banned from the Platform.
                                    During your participation in crowdsourcing projects:
                                </p>
                                <ul>
                                    <li>
                                        <strong>Be considerate:</strong> Your contribution, the answers you provide to the platform’s questionnaires will be used by other people. Try to be precise and explain your thoughts and arguments with clarity. This will facilitate the platform’s moderators work, where they will have to analyze all given answers, categorize them and produce valuable insights that can have a positive impact in the society.
                                    </li>
                                    <li><strong>Be respectful:</strong> Not all of us will agree all the time, but disagreement is no excuse for poor behavior and poor manners. We might all experience some frustration now and then, but we cannot allow that frustration to turn into a personal attack. It’s important to remember that even though the answers you provide are anonymous, an environment where people feel uncomfortable or threatened is not a productive one.
                                    </li>
                                    <li><strong>Be careful in the words that you choose</strong>Be kind to others. Even though the answers you provide are anonymous harassment and other exclusionary behavior aren’t acceptable. This includes, but is not limited to: Violent threats or language directed against another person, Discriminatory jokes and language, Posting sexually explicit or violent material, Posting (or threatening to post) other people’s personally identifying information (“doxing”), Personal insults, especially those using racist or sexist terms.
                                    </li>
                                    <li><strong>Remember that your contribution is anonymous but public:</strong>Your email and any personal information is not revealed by the platform.  Though the textual answers you provide in the questionnaires, the answers to open-ended questions, may be publicly available. Do not include any personal information in your responses that you do not wish to be publicly available.
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                This code of conduct is based on the Code of Conduct from <a href="https://openlifesci.org/code-of-conduct"> Open Life Science </a>
                            </div>
                        </div>
