...
<head>
    ...
    <meta property="og:image" content="{{asset("images/default-project/social-bg.png")}}" >
    ...
    <meta property="twitter:image" content="{{asset("images/default-project/social-bg.png")}}" >
