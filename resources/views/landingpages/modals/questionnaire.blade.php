    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{$viewModel->questionnaire->currentFieldsTranslation->title}}</h4>
            ...
            <div class="modal-body">
                <div class="container-fluid mb-5">
                    @if($viewModel->questionnaire->currentFieldsTranslation->description)
                        <div class="row">
                            <div class="col-12">
                                <div class="description-container">
                                    <div class="description">
                                        <h5>{!! $viewModel->questionnaire->currentFieldsTranslation->description !!}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
