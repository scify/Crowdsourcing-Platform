                ...
                <div class="col-12 mx-auto">
                    <div class="card card-info">
                        <div class="card-header d-flex align-items-center">
                            <h2 class="card-title mb-0">Motto Section</h2>
                            <button type="button" class="btn btn-sm btn-link ms-auto card-collapse-toggle" data-bs-toggle="collapse"
                                    data-bs-target="#card-body-landing-page-motto-section" aria-expanded="false" aria-controls="card-body-landing-page-motto-section">
                                <i class="fa fa-chevron-up"></i>
                            </button>
                        </div>
                        <div class="collapse" id="card-body-landing-page-motto-section">
                            <div class="card-body">
                    ...
                    <div class="card card-info">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <button type="button" class="btn btn-sm btn-link ms-auto card-collapse-toggle" data-bs-toggle="collapse"
                                    data-bs-target="#card-body-landing-page-about-section" aria-expanded="false" aria-controls="card-body-landing-page-about-section">
                                <i class="fa fa-chevron-up"></i>
                            </button>
                        </div>
                        <div class="collapse" id="card-body-landing-page-about-section">
                            <div class="card-body">
                                <div class="container-fluid">
                                    <div class="row">
                    ...
                    <div class="card card-info">
                        <div class="card-header d-flex align-items-center">
                            <h2 class="card-title mb-0">Active Questionnaire Section</h2>
                            <button type="button" class="btn btn-sm btn-link ms-auto card-collapse-toggle" data-bs-toggle="collapse"
                                    data-bs-target="#card-body-landing-page-active-questionnaire-section" aria-expanded="false" aria-controls="card-body-landing-page-active-questionnaire-section">
                                <i class="fa fa-chevron-up"></i>
                            </button>
                        </div>
                        <div class="collapse" id="card-body-landing-page-active-questionnaire-section">
                            <div class="card-body">
                                <div class="container-fluid">
                                    <div class="row image-input-container">
                    ...
                    <div class="card card-info">
                        <div class="card-header d-flex align-items-center">
                            <h2 class="card-title mb-0">Footer Section</h2>
                            <button type="button" class="btn btn-sm btn-link ms-auto card-collapse-toggle" data-bs-toggle="collapse"
                                    data-bs-target="#card-body-landing-page-footer-section" aria-expanded="false" aria-controls="card-body-landing-page-footer-section">
                                <i class="fa fa-chevron-up"></i>
                            </button>
                        </div>
                        <div class="collapse" id="card-body-landing-page-footer-section">
                            <div class="card-body">
                                <div class="container-fluid">
                                    <div class="row mb-3">
                                        <div class="col-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header d-flex align-items-center">
                            <h2 class="card-title mb-0">Thank You Page</h2>
                            <button type="button" class="btn btn-sm btn-link ms-auto card-collapse-toggle" data-bs-toggle="collapse"
                                    data-bs-target="#card-body-landing-page-thank-you-page" aria-expanded="false" aria-controls="card-body-landing-page-thank-you-page">
                                <i class="fa fa-chevron-up"></i>
                            </button>
                        </div>
                        <div class="collapse" id="card-body-landing-page-thank-you-page">
                            <div class="card-body">
                                <div class="container-fluid">
                                    <div class="row">
                    ...
                    <div class="card card-info">
                        <div class="card-header d-flex align-items-center">
                            <h2 class="card-title mb-0">Sticky Banner</h2>
                            <button type="button" class="btn btn-sm btn-link ms-auto card-collapse-toggle" data-bs-toggle="collapse"
                                    data-bs-target="#card-body-landing-page-sticky-banner" aria-expanded="false" aria-controls="card-body-landing-page-sticky-banner">
                                <i class="fa fa-chevron-up"></i>
                            </button>
                        </div>
                        <div class="collapse" id="card-body-landing-page-sticky-banner">
                            <div class="card-body">
                                <div class="container-fluid">
                                    <div class="row my-2">
                                        <div class="col">
