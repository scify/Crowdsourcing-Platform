        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label" for="status_id">Project status</label>

                            <small class="text-blue ms-2">(The project status can only be changed by a platform
                                administrator.)</small>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label" for="user_creator_id">Project Creator / Manager</label>
                            <small class="text-blue ms-2">(Only platform administrators can change this assignment.)</small>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mb-3 has-feedback {{ $errors->has('slug') ? 'has-error' : '' }}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mb-3 has-feedback {{ $errors->has('external_url') ? 'has-error' : '' }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label" for="default_lang_id">Project Default Language</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label" for="max_votes_per_user_for_solutions">
