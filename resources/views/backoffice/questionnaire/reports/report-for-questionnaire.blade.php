        ...
        <div class="row mb-2">
            <div class="col-12">
                Click <a
                        ...
                        target="_blank">here</a> to view the statistics and moderate the responses.
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                Click <a
                        ...
                        target="_blank">here</a> to download the votes for open-ended <b>questionnaire</b> questions.
            </div>
        </div>
    </div>
</div>
