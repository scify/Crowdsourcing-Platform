...
return [
    ...
    */
    ...
    'thank_you_next_steps' => 'Σας ευχαριστούμε για τη συμμετοχή σας στο ερωτηματολόγιο, οι απαντήσεις και ο χρόνος σας είναι υψηλά εκτιμημένα. Ήδη ετοιμάζουμε τη δεύτερη φάση αυτής της πρωτοβουλίας, η οποία θα επικεντρωθεί στην ανάπτυξη λύσεων.',
];
