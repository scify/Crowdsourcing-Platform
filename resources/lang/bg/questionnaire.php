...
return [
    ...
    */
    ...
    'thank_you_next_steps' => 'Благодарим ви за участието в анкетата! Ценим високо Вашите отговори и отделеното време. Вече подготвяме втората фаза на тази инициатива, която ще се фокусира върху разработването на решения на посочените от Вас проблеми.',
];
