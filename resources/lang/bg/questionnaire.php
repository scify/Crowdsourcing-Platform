...
return [
    ...
    */
    ...
    'by_registering_you' => 'Като се регистрирате,<sup>*</sup> Вие:', 
    'filter_spammers' => 'ни помагате да филтрираме спама и хората, които дават случайни отговори.',
    'view_your_contribution' => 'получавате възможността да прегледате своите отговорите си и да ги сравните с тези на останалите.',
    'vote_thumbs_up' => 'ще можете да гласувате за най-добрите отговори',
    ...
    'feedback_about_platform' => 'Моля, дайте ни мнението си за платформата като отговорите на 4 въпроса', //den ta exo brei kapou
